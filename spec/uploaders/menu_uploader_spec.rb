...
describe MenuUploader do
  include CarrierWave::Test::Matchers

  before do
    ImageUploader.enable_processing = true
    @restaurant = Restaurant.create(name: "Sample", description: "sample sample", address: "sample address", phone_number: "sample number", image: "sample_image", menu: "menu")
    @uploader = ImageUploader.new(@restaurant, :menu)
